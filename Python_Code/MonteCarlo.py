        ...
        for gamma_star in sz_gamma:       
            ...
            for omega in sz_omega:                         
                for T in sz_maturity: #eventuell unnötig langer pfad modellieren und kürzen?!                            
                    ...
                    #    K = Moneyness*S_0
                                        #for r in sz_rate:        
                    vola = HNG_MC(alpha, beta, gamma_star, omega, d_lambda, S, K, r, T, dt, output=0)
                    szenario_vola_calls[(alpha,beta,gamma_star,omega,T)] =  vola
