...
load('../Datasets/NASDAQ100/NASDAQ100_date_prices_returns.mat')
...
query = 'SELECT * FROM omeos WHERE secid = 102480 AND date >= DATE("2008-01-01") AND date <= DATE("2008-12-31") AND cp_flag ="C" AND exercise_style = "E" AND volume > 100 AND open_interest > 100 AND vega != "NaN" AND div_convention = "I"';     % LIMIT 20';     
%108105 SP500
%102456 DJIA
%102480 NASDAQ100
